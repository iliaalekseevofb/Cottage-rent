...
const characteristicsContent = [
  ...
  [<FaSmileBeam size={28} className='text-orange-500' />, 'Удобства:', 'Wi-Fi, телевизор, холодильник, фен, ванная, балкон'],
  [<FaBed size={28} className='text-orange-500' />, 'Тип кровати:', 'Большая двуспальная кровать'],
